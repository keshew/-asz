...
struct DiceRollView: View {
    @StateObject var viewModel =  DiceRollViewModel()
                                            ...
                                            .overlay {
                                                RoundedRectangle(cornerRadius: 14)
                                                    ...
                                                    .overlay {
                                                        VStack(spacing: 20) {
                                                            Rectangle()
                                                                .fill(LinearGradient(colors: [Color(red: 249/255, green: 115/255, blue: 23/255),
                                                                                              Color(red: 239/255, green: 69/255, blue: 68/255)],
                                                                                      startPoint: .topLeading, endPoint: .bottomTrailing))
                                                                .frame(width: 80, height: 80)
                                                                .overlay {
                                                                    RoundedRectangle(cornerRadius: 12)
                                                                        .stroke(Color(red: 253/255, green: 186/255, blue: 116/255), lineWidth: 3)
                                                                        .overlay {
                                                                            Text("\(viewModel.currentDisplayNumber)")
                                                                                .font(.custom("PaytoneOne-Regular", size: 44))
                                                                ...
                                                                .animation(.easeInOut(duration: 0.25), value: viewModel.rotationStep)
