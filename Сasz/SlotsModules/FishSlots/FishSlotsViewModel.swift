...
class FishSlotsViewModel: ObservableObject {
    let contact = FishSlotsModel()
    ...
    let symbolArray = [
        Symbol(image: "fish1", value: "200"),
        Symbol(image: "fish2", value: "100"),
        Symbol(image: "fish3", value: "75"),
        Symbol(image: "fish4", value: "50"),
        Symbol(image: "fish5", value: "25"),
        Symbol(image: "fish6", value: "10")
    ]
