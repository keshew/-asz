...
struct PayTable: Identifiable {
    var id = UUID()
    var image: String
    var mult: String
}
struct FishSlotsView: View {
    @StateObject var viewModel =  FishSlotsViewModel()
    @State var isOpenPaytable = false
    @State var isOpenGameRules = false
    @Environment(\.presentationMode) var presentationMode
    var paytable = [PayTable(image: "fish1", mult: "200x"),
                    PayTable(image: "fish2", mult: "100x"),
                    PayTable(image: "fish3", mult: "75x"),
                    PayTable(image: "fish4", mult: "50x"),
                    PayTable(image: "fish5", mult: "25x"),
                    PayTable(image: "fish6", mult: "10x")]
        ...
        ZStack {
            ZStack(alignment: .top) {
                ...
                ZStack(alignment: .bottom) {
                    Color(red: 28/255, green: 56/255, blue: 74/255).opacity(0.95)
                        .frame(height: 70)
                    
                    Rectangle()
                        .foregroundStyle(Color(red: 242/255, green: 204/255, blue: 12/255).opacity(0.3))
                        .frame(height: 1)
                }
            }
            .ignoresSafeArea()
                    ...
                    VStack(spacing: 8) {
                        ...
                        ScrollView(showsIndicators: false) {
                            HStack {
                                        ...
                                        VStack(spacing: 10) {
                                            ...
                                            if isOpenPaytable {
                                                ForEach(paytable) { table in
                                                    VStack(alignment: .leading) {
                                                        Rectangle()
                                                            .fill(Color(red: 30/255, green: 72/255, blue: 93/255))
                                                            .overlay {
                                                                HStack {
                                                                    Image(table.image)
                                                                        .resizable()
                                            ...
                                            Button(action: {
                                                ...
                                                Text("SPIN")
                                                    ...
                                                    .padding(.horizontal, 10)
                                                    .padding(.vertical, 7)
                                                    .background(LinearGradient(colors: [Color(red: 10/255, green: 163/255, blue: 245/255),
                                                                                        Color(red: 21/255, green: 192/255, blue: 249/255)], startPoint: .leading, endPoint: .trailing))
                                                    .cornerRadius(5)
                                                    .overlay {
                                ...
                                VStack {
                                    Rectangle()
                                        .fill(Color(red: 29/255, green: 65/255, blue: 84/255))
                                        .overlay {
                                            RoundedRectangle(cornerRadius: 14)
                                                .stroke(Color(red: 48/255, green: 114/255, blue: 170/255), lineWidth: 7)
                                                .overlay {
                                                    VStack(spacing: 15) {
                                                        ForEach(0..<3, id: \.self) { row in
                                                            HStack(spacing: 15) {
                                                                ForEach(0..<5, id: \.self) { col in
                                                                    Rectangle()
                                                                        .fill(Color(red: 35/255, green: 84/255, blue: 123/255))
                                                                        .frame(width: 90, height: 75)
                                                                        .overlay {
                                                                            RoundedRectangle(cornerRadius: 8)
                                                                                .stroke(Color(red: 99/255, green: 120/255, blue: 90/255), lineWidth: 3)
                                                                                .overlay {
