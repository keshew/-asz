...
struct EgyptSlotsView: View {
    ...
    var paytable = [PayTable(image: "eg1", mult: "200x"),
                    PayTable(image: "eg2", mult: "100x"),
                    PayTable(image: "eg3", mult: "75x"),
                    PayTable(image: "eg4", mult: "50x"),
                    PayTable(image: "eg5", mult: "25x"),
                    PayTable(image: "eg6", mult: "10x")]
        ...
        ZStack {
            ZStack(alignment: .top) {
                ...
                ZStack(alignment: .bottom) {
                    Color(red: 74/255, green: 64/255, blue: 28/255).opacity(0.95)
                        .frame(height: 70)
                        ...
                        HStack(spacing: 20) {
                            ...
                            HStack {
                                ...
                                Button(action: {
                                    ...
                                    Rectangle()
                                        ...
                                        .overlay {
                                            RoundedRectangle(cornerRadius: 4)
                                                .stroke(Color(red: 239/255, green: 208/255, blue: 0/255), lineWidth: 2)
                                                .overlay {
                                                    Text("+")
                                                        .font(.custom("PaytoneOne-Regular", size: 24))
                                                        .foregroundStyle(Color(red: 245/255, green: 199/255, blue: 61/255))
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 12)
                                    .stroke(Color(red: 239/255, green: 208/255, blue: 0/255), lineWidth: 3)
                            }
                        }
                        .padding(.top)
                        .padding(.horizontal)
                                        ...
                                        VStack(spacing: 10) {
                                            ...
                                            if isOpenPaytable {
                                                ForEach(paytable) { table in
                                                    VStack(alignment: .leading) {
                                                        Rectangle()
                                                            .fill(Color(red: 93/255, green: 76/255, blue: 31/255))
                                                            .overlay {
                                                                HStack {
                                                                    Image(table.image)
                                                                        .resizable()
                                            ...
                                            Button(action: {
                                                ...
                                                Text("SPIN")
                                                    ...
                                                    .padding(.horizontal, 10)
                                                    .padding(.vertical, 7)
                                                    .background(LinearGradient(colors: [Color(red: 245/255, green: 158/255, blue: 10/255),
                                                                                        Color(red: 249/255, green: 220/255, blue: 20/255)], startPoint: .leading, endPoint: .trailing))
                                                    .cornerRadius(5)
                                                    .overlay {
                                    ...
                                    Rectangle()
                                        ...
                                        .overlay {
                                            RoundedRectangle(cornerRadius: 14)
                                                .stroke(Color(red: 171/255, green: 141/255, blue: 49/255), lineWidth: 7)
                                                .overlay {
                                                    VStack(spacing: 15) {
                                                        ForEach(0..<3, id: \.self) { row in
                                                            HStack(spacing: 15) {
                                                                ForEach(0..<5, id: \.self) { col in
                                                                    Rectangle()
                                                                        .fill(Color(red: 123/255, green: 106/255, blue: 36/255))
                                                                        .frame(width: 90, height: 75)
                                                                        .overlay {
                                                                            RoundedRectangle(cornerRadius: 8)
                                                                                .stroke(Color(red: 159/255, green: 135/255, blue: 30/255), lineWidth: 3)
                                                                                .overlay {
