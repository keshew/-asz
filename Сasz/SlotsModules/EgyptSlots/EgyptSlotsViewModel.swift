...
class EgyptSlotsViewModel: ObservableObject {
    ...
    let symbolArray = [
        ...
        Symbol(image: "eg2", value: "100"),
        Symbol(image: "eg3", value: "75"),
        Symbol(image: "eg4", value: "50"),
        Symbol(image: "eg5", value: "25"),
        Symbol(image: "eg6", value: "10")
    ]
